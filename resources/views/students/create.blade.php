...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="mb-0"><i class="fas fa-user-plus text-primary me-2"></i>Create Student</h4>
        ...
        <div class="card-body p-4">
            <form method="POST" action="{{ route('students.store') }}" id="studentForm">
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" class="form-control bg-light @error('sl_no') is-invalid @enderror" 
                                   name="sl_no" id="sl_no" value="{{ old('sl_no') }}" placeholder="Auto-generated" readonly>
                        </div>
                        @error('sl_no')
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('admission_date') is-invalid @enderror" 
                                   ...
                                   placeholder="dd-mm-yyyy" maxlength="10" pattern="\d{2}-\d{2}-\d{4}">
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('admission_no') is-invalid @enderror" 
                                   name="admission_no" id="admission_no" value="{{ old('admission_no') }}" 
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select @error('class') is-invalid @enderror" name="class">
                                ...
                                <option value="Eleven" {{ old('class') == 'Eleven' ? 'selected' : '' }}>Eleven</option>
                                <option value="Twelve" {{ old('class') == 'Twelve' ? 'selected' : '' }}>Twelve</option>
                            </select>
                        </div>
                        @error('class')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                ...
                <div class="row g-3 mt-1">
                    ...
                    <div class="col-md-4">
                        <label class="form-label fw-semibold">
                            <i class="fas fa-user text-muted me-1"></i>Student Name
                        </label>
                        <div class="input-group">
                            <span class="input-group-text bg-light"><i class="fas fa-user-circle text-muted"></i></span>
                            <input type="text" class="form-control @error('student_name') is-invalid @enderror" 
                                   name="student_name" id="student_name" value="{{ old('student_name') }}" 
                                   placeholder="Enter Student Name" style="text-transform: uppercase;" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('pen_number') is-invalid @enderror" 
                                   name="pen_number" id="pen_number" value="{{ old('pen_number') }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('aapaar_id') is-invalid @enderror" 
                                   name="aapaar_id" id="aapaar_id" value="{{ old('aapaar_id') }}" maxlength="12" 
                                   placeholder="Enter 12 digit Aapaar ID" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                        @error('aapaar_id')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('dob') is-invalid @enderror" 
                                   name="dob" value="{{ old('dob') }}" placeholder="dd-mm-yyyy" id="dob" maxlength="10">
                        </div>
                        @error('dob')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('mobile_no') is-invalid @enderror" 
                                   name="mobile_no" id="mobile_no" value="{{ old('mobile_no') }}" maxlength="10" 
                                   placeholder="Enter 10 digit mobile" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                        @error('mobile_no')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('height') is-invalid @enderror" 
                                   name="height" value="{{ old('height') }}" min="0" max="10" placeholder="Enter height">
                        </div>
                        @error('height')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" class="form-control @error('weight') is-invalid @enderror" 
                                   name="weight" value="{{ old('weight') }}" min="0" max="500" placeholder="Enter weight">
                        </div>
                        @error('weight')
                            <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('address_village') is-invalid @enderror" 
                                   name="address_village" id="address_village" value="{{ old('address_village') }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('subdiv') is-invalid @enderror" 
                                   name="subdiv" id="subdiv" value="{{ old('subdiv') }}" 
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('address_state') is-invalid @enderror" 
                                   name="address_state" id="address_state" value="{{ old('address_state') }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('dropout_school') is-invalid @enderror" 
                                   name="dropout_school" id="dropout_school" value="{{ old('dropout_school') }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('dropout_date') is-invalid @enderror" 
                                   name="dropout_date" id="dropout_date" value="{{ old('dropout_date') }}" 
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <textarea class="form-control @error('dropout_reason') is-invalid @enderror" 
                                      name="dropout_reason" rows="2" placeholder="Enter reason" style="text-transform: uppercase;">{{ old('dropout_reason') }}</textarea>
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('ifsc') is-invalid @enderror" 
                                   name="ifsc" id="ifsc" value="{{ old('ifsc') }}" maxlength="11" 
                                   style="text-transform: uppercase;" placeholder="Enter IFSC"
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('aadhar_number') is-invalid @enderror" 
                                   name="aadhar_number" id="aadhar_number" value="{{ old('aadhar_number') }}" 
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('father_aadhar_number') is-invalid @enderror" 
                                   name="father_aadhar_number" id="father_aadhar_number" value="{{ old('father_aadhar_number') }}" 
                                   maxlength="12" placeholder="Enter 12 digits" oninput="this.value = this.value.replace(/[^0-9]/g, '')">
                        </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('father_voter_id_no') is-invalid @enderror" 
                                   name="father_voter_id_no" id="father_voter_id_no" value="{{ old('father_voter_id_no') }}" 
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control @error('father_pan_no') is-invalid @enderror" 
                                   name="father_pan_no" id="father_pan_no" value="{{ old('father_pan_no') }}" 
...
document.addEventListener('DOMContentLoaded', function() {
    // SL No will be auto-generated by server, just show placeholder
    const slNoInput = document.getElementById('sl_no');
