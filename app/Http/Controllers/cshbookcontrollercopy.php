...
class CashbookController extends Controller
{
    ...
    public function print(Cashbook $cashbook)
    {
        ...
        // Pagination settings - approximately 20 rows per page (adjust based on your needs)
        $rowsPerPage = 20;
        ...
        foreach ($receiptChunks as $chunk) {
            ...
            $pageReceiptTotalCash = $pageReceipts->sum('cash_amount');
            $pageReceiptTotalBank = $pageReceipts->sum('bank_amount');
            $pageReceiptTotal = $pageReceiptTotalCash + $pageReceiptTotalBank;
            ...
            $runningReceiptCash += $pageReceiptTotalCash;
            $runningReceiptBank += $pageReceiptTotalBank;
        ...
        foreach ($paymentChunks as $chunk) {
            ...
            $pagePaymentTotalCash = $pagePayments->sum('cash_amount');
            $pagePaymentTotalBank = $pagePayments->sum('bank_amount');
            $pagePaymentTotal = $pagePaymentTotalCash + $pagePaymentTotalBank;
            ...
            // Update running totals
            $runningPaymentCash += $pagePaymentTotalCash;
            $runningPaymentBank += $pagePaymentTotalBank;
