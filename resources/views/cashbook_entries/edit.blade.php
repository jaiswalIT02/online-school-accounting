...
<div class="container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-0">Edit Entry - {{ $cashbook->name }}</h4>
        <a class="btn btn-outline-secondary" href="{{ route('cashbooks.show', $cashbook) }}">Back</a>
    </div>

    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('cashbook_entries.update', $entry) }}">
                @csrf
                @method('PUT')
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input
                            ...
                            maxlength="8"
                            value="{{ old('entry_date', optional($entry->entry_date)->format('d/m/y')) }}"
                            required
                        >
                        @error('entry_date')
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <select
                            ...
                            required
                        >
                            @php($selectedType = old('type', $type ?? $entry->type))
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            step="0.01"
                            min="0"
                            value="{{ old('cash_amount', $entry->cash_amount) }}"
                        >
                        @error('cash_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input
                            ...
                            step="0.01"
                            min="0"
                            value="{{ old('bank_amount', $entry->bank_amount) }}"
                        >
                        @error('bank_amount')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
